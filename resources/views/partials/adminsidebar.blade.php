 <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <li class="nav-item {{ Request::segment(1) == 'users' ? 'active' : '' }}">
        <a href="/users" class="nav-link">
          ...
          <span class="sidebar-text">Manage All Users</span>
        </a>
      </li>
      ...
      <li class="nav-item {{ Request::segment(1) == 'staff' ? 'active' : '' }}">
        <a href="/users" class="nav-link">
          ...
          <span class="sidebar-text">Clinical Professionals </span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
          ...
          <span>
            ...
            {{-- <span class="sidebar-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="icon icon-xs me-2" fill="currentColor">
            ...
            <span class="sidebar-text">Billing and Invoicing</span>
          </span>
      ...
      <li class="nav-item {{ Request::segment(1) == 'reports' ? 'active' : '' }}">
        <a href="/reports" class="nav-link">
          ...
          <span class="sidebar-text">Report and Analytics </span>
